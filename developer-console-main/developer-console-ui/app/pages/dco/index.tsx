...
const Dco = ({ children }: any) => {
  ...
  const analyticsTabClicked = router.pathname === '/dco/analytics'
            ...
            <Flex valign='bottom'>
              ...
              <Flex.Item autoSize>
                <NavigationBar>
                  ...
                  <ActiveLink href={checkRoute('/dco/analytics', router, pathname)}>
                    <NavigationBarItem>Analytics</NavigationBarItem>
                  </ActiveLink>
                </NavigationBar>
              </Flex.Item>
              {/* RIGHT */}
